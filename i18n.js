...
const TRANSLATIONS = {
  es: {
    ...
    contact_privacy_note: "Uso tu nombre y mail solo para responderte. <a href='#privacidad'>Más sobre privacidad</a>.",
    priv_kicker: "Privacidad",
    priv_h2: "Tu información, en pocas palabras.",
    priv_lede: "Neko Tools no tiene cuentas ni publicidad. Esto es todo lo que pasa con tus datos.",
    priv_1_h: "Tu lista es tuya.",
    priv_1_p: "Neko Lista guarda tus productos solo en tu dispositivo. Nosotros no los vemos ni los guardamos, salvo si usás un código de transferencia (más abajo).",
    priv_2_h: "Códigos de transferencia.",
    priv_2_p: "Si pasás tu lista a otro dispositivo con un código, se sube a nuestro servidor solo mientras el código sea válido: 15 minutos o hasta que se use, lo que pase primero. Después se borra.",
    priv_3_h: "Formulario de contacto.",
    priv_3_p: "Tu nombre, mail y mensaje llegan a mi correo y los uso solo para responderte. No los comparto ni los uso para publicidad. Si querés que borre un mensaje, pedímelo por el mismo formulario.",
    priv_4_h: "Sin seguimiento.",
    priv_4_p: "No usamos cookies de seguimiento, analítica ni publicidad.",
    priv_5_h: "Servicios de terceros.",
    priv_5_p: "Las tipografías se cargan desde Google Fonts, y para leer PDF o fotos la app descarga librerías de cdnjs y jsDelivr; esos servicios ven tu dirección IP al cargarse. Los apoyos pasan por Ko-fi, que tiene su propia política. Además, el hosting registra visitas técnicas (IP y fecha), y para evitar abusos guardamos por un par de horas una huella cifrada de tu conexión, no tu IP.",
  ...
  en: {
    ...
    contact_privacy_note: "I use your name and email only to reply to you. <a href='#privacidad'>More about privacy</a>.",
    priv_kicker: "Privacy",
    priv_h2: "Your information, in plain words.",
    priv_lede: "Neko Tools has no accounts and no ads. This is everything that happens with your data.",
    priv_1_h: "Your list is yours.",
    priv_1_p: "Neko Lista keeps your products only on your device. We never see them or store them, unless you use a transfer code (see below).",
    priv_2_h: "Transfer codes.",
    priv_2_p: "If you move your list to another device with a code, it is uploaded to our server only while the code is valid: 15 minutes or until it is used, whichever comes first. Then it is deleted.",
    priv_3_h: "Contact form.",
    priv_3_p: "Your name, email and message reach my inbox and I use them only to reply to you. I don't share them or use them for advertising. If you want me to delete a message, ask me through the same form.",
    priv_4_h: "No tracking.",
    priv_4_p: "We don't use tracking cookies, analytics or advertising.",
    priv_5_h: "Third-party services.",
    priv_5_p: "Fonts load from Google Fonts, and to read PDFs or photos the app downloads libraries from cdnjs and jsDelivr; those services see your IP address when they load. Support goes through Ko-fi, which has its own policy. Also, the hosting records technical visits (IP and date), and to prevent abuse we keep an encrypted fingerprint of your connection, not your IP, for a couple of hours.",
    float1_k: "Updates",
    float1_v: "instantly",
  ...
  pt: {
    ...
    contact_privacy_note: "Uso seu nome e e-mail apenas para responder você. <a href='#privacidad'>Mais sobre privacidade</a>.",
    priv_kicker: "Privacidade",
    priv_h2: "Suas informações, em poucas palavras.",
    priv_lede: "O Neko Tools não tem contas nem publicidade. Isto é tudo o que acontece com seus dados.",
    priv_1_h: "Sua lista é sua.",
    priv_1_p: "O Neko Lista guarda seus produtos apenas no seu dispositivo. Nós não os vemos nem os guardamos, a menos que você use um código de transferência (veja abaixo).",
    priv_2_h: "Códigos de transferência.",
    priv_2_p: "Se você passa sua lista para outro dispositivo com um código, ela é enviada ao nosso servidor apenas enquanto o código for válido: 15 minutos ou até ser usado, o que ocorrer primeiro. Depois é apagada.",
    priv_3_h: "Formulário de contato.",
    priv_3_p: "Seu nome, e-mail e mensagem chegam à minha caixa de entrada e os uso apenas para responder você. Não os compartilho nem os uso para publicidade. Se quiser que eu apague uma mensagem, peça pelo mesmo formulário.",
    priv_4_h: "Sem rastreamento.",
    priv_4_p: "Não usamos cookies de rastreamento, análise nem publicidade.",
    priv_5_h: "Serviços de terceiros.",
    priv_5_p: "As fontes são carregadas do Google Fonts e, para ler PDFs ou fotos, o app baixa bibliotecas do cdnjs e do jsDelivr; esses serviços veem seu endereço IP ao carregar. Os apoios passam pelo Ko-fi, que tem sua própria política. Além disso, a hospedagem registra visitas técnicas (IP e data) e, para evitar abusos, guardamos por algumas horas uma impressão criptografada da sua conexão, não seu IP.",
    float1_k: "Atualiza",
    float1_v: "na hora",
    float2_k: "Menos pensar",
  ...
  tr: {
    ...
    contact_privacy_note: "Adını ve e-postanı yalnızca sana cevap vermek için kullanırım. <a href='#privacidad'>Gizlilik hakkında daha fazlası</a>.",
    priv_kicker: "Gizlilik",
    priv_h2: "Bilgilerin, kısaca.",
    priv_lede: "Neko Tools'ta hesap ve reklam yok. Verilerinle olan her şey bundan ibaret.",
    priv_1_h: "Listen senin.",
    priv_1_p: "Neko Lista ürünlerini yalnızca cihazında saklar. Biz onları görmeyiz ve saklamayız; tek istisna aktarım kodu kullanmandır (aşağıya bak).",
    priv_2_h: "Aktarım kodları.",
    priv_2_p: "Listeni bir kodla başka bir cihaza aktarırsan, liste sunucumuza yalnızca kod geçerli olduğu sürece yüklenir: 15 dakika veya kullanılana kadar, hangisi önce olursa. Sonra silinir.",
    priv_3_h: "İletişim formu.",
    priv_3_p: "Adın, e-postan ve mesajın gelen kutuma ulaşır ve yalnızca sana cevap vermek için kullanırım. Onları paylaşmam ve reklam için kullanmam. Bir mesajı silmemi istersen aynı form üzerinden yazman yeterli.",
    priv_4_h: "İzleme yok.",
    priv_4_p: "İzleme çerezleri, analiz veya reklam kullanmıyoruz.",
    priv_5_h: "Üçüncü taraf hizmetler.",
    priv_5_p: "Yazı tipleri Google Fonts'tan yüklenir; PDF veya fotoğraf okumak için uygulama cdnjs ve jsDelivr'dan kütüphaneler indirir ve bu hizmetler yüklenirken IP adresini görür. Destekler, kendi politikası olan Ko-fi üzerinden geçer. Ayrıca barındırma hizmeti teknik ziyaretleri (IP ve tarih) kaydeder ve kötüye kullanımı önlemek için bağlantının şifrelenmiş bir izini, IP'ni değil, birkaç saat saklarız.",
  ...
  ru: {
    ...
    contact_privacy_note: "Я использую ваше имя и почту только чтобы ответить вам. <a href='#privacidad'>Подробнее о конфиденциальности</a>.",
    priv_kicker: "Конфиденциальность",
    priv_h2: "Ваши данные — коротко.",
    priv_lede: "В Neko Tools нет аккаунтов и рекламы. Вот всё, что происходит с вашими данными.",
    priv_1_h: "Ваш список принадлежит вам.",
    priv_1_p: "Neko Lista хранит ваши товары только на вашем устройстве. Мы их не видим и не храним, если только вы не используете код передачи (см. ниже).",
    priv_2_h: "Коды передачи.",
    priv_2_p: "Если вы переносите список на другое устройство с помощью кода, он загружается на наш сервер только на время действия кода: 15 минут или до первого использования — что наступит раньше. Затем он удаляется.",
    priv_3_h: "Форма обратной связи.",
    priv_3_p: "Ваше имя, почта и сообщение приходят мне на почту, и я использую их только чтобы ответить вам. Я не передаю их третьим лицам и не использую для рекламы. Если хотите, чтобы я удалил сообщение, напишите через ту же форму.",
    priv_4_h: "Без отслеживания.",
    priv_4_p: "Мы не используем cookie для отслеживания, аналитику и рекламу.",
    priv_5_h: "Сторонние сервисы.",
    priv_5_p: "Шрифты загружаются из Google Fonts, а для чтения PDF и фото приложение скачивает библиотеки с cdnjs и jsDelivr; эти сервисы видят ваш IP-адрес при загрузке. Поддержка проходит через Ko-fi, у которого своя политика. Кроме того, хостинг записывает технические визиты (IP и дату), а для защиты от злоупотреблений мы на пару часов сохраняем зашифрованный отпечаток вашего соединения, а не ваш IP.",
  ...
  ja: {
    ...
    contact_privacy_note: "お名前とメールアドレスは返信のためだけに使います。<a href='#privacidad'>プライバシーの詳細</a>。",
    priv_kicker: "プライバシー",
    priv_h2: "あなたの情報について、かんたんに。",
    priv_lede: "Neko Toolsにはアカウントも広告もありません。あなたのデータについて行っていることは、以下がすべてです。",
    priv_1_h: "リストはあなたのものです。",
    priv_1_p: "Neko Listaは商品をあなたのデバイスの中だけに保存します。転送コードを使う場合（下記）を除き、私たちがそれを見ることも保存することもありません。",
    priv_2_h: "転送コード。",
    priv_2_p: "コードを使ってリストを別のデバイスに移す場合、リストはコードが有効な間だけ（15分、または使用されるまでのどちらか早い方）サーバーにアップロードされ、その後削除されます。",
    priv_3_h: "お問い合わせフォーム。",
    priv_3_p: "お名前、メールアドレス、メッセージは私の受信箱に届き、返信のためだけに使います。第三者への共有や広告への利用はしません。メッセージの削除を希望する場合は、同じフォームからご連絡ください。",
    priv_4_h: "トラッキングなし。",
    priv_4_p: "トラッキング用のCookie、アクセス解析、広告は使用していません。",
    priv_5_h: "外部サービス。",
    priv_5_p: "フォントはGoogle Fontsから読み込まれ、PDFや写真を読み取る際にはcdnjsとjsDelivrからライブラリをダウンロードします。これらのサービスは読み込み時にIPアドレスを確認できます。ご支援はKo-fi経由で、Ko-fi独自のポリシーが適用されます。また、ホスティング側で技術的なアクセス記録（IPと日時）が保存され、不正利用防止のため、接続の暗号化された識別値（IPそのものではありません）を数時間保管します。",
    float1_k: "更新は",
    float1_v: "その場で",
    float2_k: "考える手間を減らして",
    float2_v: "自分の時間を増やそう",
