...
const TRANSLATIONS = {
  es: {
    ...
    contact_privacy_note: "Uso tu nombre y mail solo para responderte. <a href='privacidad.html' target='_blank' rel='noopener'>Más sobre privacidad</a>.",
    priv_kicker: "Privacidad",
    priv_back: "Volver al inicio",
    priv_tag_ads: "Sin anuncios",
    priv_tag_tracking: "Sin seguimiento",
    priv_foot: "¿Alguna duda sobre tus datos? <a href='./#marca'>Escribime</a>.",
  ...
  en: {
    ...
    contact_privacy_note: "I use your name and email only to reply to you. <a href='privacidad.html' target='_blank' rel='noopener'>More about privacy</a>.",
    priv_kicker: "Privacy",
    priv_back: "Back to home",
    priv_tag_ads: "No ads",
    priv_tag_tracking: "No tracking",
    priv_foot: "Questions about your data? <a href='./#marca'>Write to me</a>.",
  ...
  pt: {
    ...
    contact_privacy_note: "Uso seu nome e e-mail apenas para responder você. <a href='privacidad.html' target='_blank' rel='noopener'>Mais sobre privacidade</a>.",
    priv_kicker: "Privacidade",
    priv_back: "Voltar ao início",
    priv_tag_ads: "Sem anúncios",
    priv_tag_tracking: "Sem rastreamento",
    priv_foot: "Alguma dúvida sobre seus dados? <a href='./#marca'>Escreva para mim</a>.",
  ...
  tr: {
    ...
    contact_privacy_note: "Adını ve e-postanı yalnızca sana cevap vermek için kullanırım. <a href='privacidad.html' target='_blank' rel='noopener'>Gizlilik hakkında daha fazlası</a>.",
    priv_kicker: "Gizlilik",
    priv_back: "Ana sayfaya dön",
    priv_tag_ads: "Reklam yok",
    priv_tag_tracking: "İzleme yok",
    priv_foot: "Verilerinle ilgili bir sorun mu var? <a href='./#marca'>Bana yaz</a>.",
  ...
  ru: {
    ...
    contact_privacy_note: "Я использую ваше имя и почту только чтобы ответить вам. <a href='privacidad.html' target='_blank' rel='noopener'>Подробнее о конфиденциальности</a>.",
    priv_kicker: "Конфиденциальность",
    priv_back: "На главную",
    priv_tag_ads: "Без рекламы",
    priv_tag_tracking: "Без отслеживания",
    priv_foot: "Есть вопросы о ваших данных? <a href='./#marca'>Напишите мне</a>.",
  ...
  ja: {
    ...
    contact_privacy_note: "お名前とメールアドレスは返信のためだけに使います。<a href='privacidad.html' target='_blank' rel='noopener'>プライバシーの詳細</a>。",
    priv_kicker: "プライバシー",
    priv_back: "ホームに戻る",
    priv_tag_ads: "広告なし",
    priv_tag_tracking: "トラッキングなし",
    priv_foot: "データについてご質問がありますか？<a href='./#marca'>ご連絡ください</a>。",
